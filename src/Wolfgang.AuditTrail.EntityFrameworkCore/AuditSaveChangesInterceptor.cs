...
{
    private const string PendingItemsKey = "Wolfgang.AuditTrail.Pending";
    private const string OwnedTxItemsKey = "Wolfgang.AuditTrail.OwnedTransaction";
    private const string TxIdItemsKey    = "Wolfgang.AuditTrail.TransactionId";
    private const string SuppressItemsKey = "Wolfgang.AuditTrail.Suppress";
