...
namespace Wolfgang.AuditTrail.Entities;
...
public class AuditDetail
{
    ...
    /// <c>DateTime</c>, <c>Guid</c>, <c>Enum:&lt;AssemblyQualifiedName&gt;</c>, etc.
    /// Enums use the assembly-qualified name (not the bare full type name) so
    /// consumer-assembly enum types resolve correctly on decode.
    /// </summary>
