...
The `dotnet format` command is **built into the .NET SDK** starting with .NET 6 and later. Since this project requires .NET 10.0 SDK or later, you already have `dotnet format` available — no separate tool installation is needed.
